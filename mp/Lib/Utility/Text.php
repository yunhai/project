 ...
 */
    public static function truncate($text, $length = 100, $options = []) {
        ...
        if ($html) {
            if (empty($img)) {
                $text = preg_replace("/<img[^>]+\>/i", $alt, $text);
            }
 ...
 */
    ...
    public static function slug($strAccent = "", $sepchar = "-", $preg = "", $removeSpecial = true) {
        ...
        $strNoAccent = preg_replace($preg, $sepchar, $strNoAccent);
        ...
        if ($removeSpecial) {
            ...
            $strNoAccent = str_replace($specialcharArr, $sepchar, $strNoAccent);
        }
        ...
        return strtolower($strNoAccent);
    }

    public static function regx($string = '', $expression = '', $replace = '') {
        return self::removeDuplicate(preg_replace($expression, $replace, $string), $replace);
    }

    public static function removeDuplicate($string = '', $character = '') {
