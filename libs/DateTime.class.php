...
//		);
		...
		$daytext = array(	'Mon'	=> $vsLang->getWords('global_d_mo','Thứ hai'),
							'Tue'	=> $vsLang->getWords('global_d_tu','Thứ ba'),
							'Wed'	=> $vsLang->getWords('global_d_we','Thứ tư'),
							'Thu'	=> $vsLang->getWords('global_d_th','Thứ năm'),
							'Fri'	=> $vsLang->getWords('global_d_fr','Thứ sáu'),
							'Sat'	=> $vsLang->getWords('global_d_sa','Thứ bảy'),
							'Sun'	=> $vsLang->getWords('global_d_su','Chủ nhật'),
		);
