				...
				<table cellspacing="1" cellpadding="1" id='productListTable' width="100%">
					...
					<th>{$vsLang->getWords('order_name','Họ và tên')}</th>
			                ...
			                <th>{$vsLang->getWords('order_email','Email')}</th>
											<th>{$vsLang->getWords('order_info','Địa chỉ giao hàng')}</th>
                                                    ...
                                                    <foreach="$option['pageList'] as $obj">
                                                        <tr class="$vsf_class">
                                                                ...
                                                                <td>{$obj->getEmail()}</td>
																																<td>
																																	{$obj->getU('address')}<br />
																																  ({$obj->getU('fullname')}, {$obj->getU('phone')})
																																</td>
		...
		<div class='ui-dialog ui-widget ui-widget-content ui-corner-all'>
                ...
                <table cellpadding="1" cellspacing="1" >
                        ...
                        <td>{$option['customer']->getPhone()}</td>
								...
								<tr align="left">
                	<th>{$vsLang->getWords('order_receipt_name','Họ tên người nhận')}:</th>
                        <td>{$option['customer']->getU('fullname')}</td>
                </tr>
                <tr align="left">
                         <th>{$vsLang->getWords('order_receipt_address','Địa chỉ người nhận')}:</th>
                        <td>{$option['customer']->getU('address')}</td>
                </tr>
                <tr align="left">
                        <th>{$vsLang->getWords('order_receipt_phone','Điện thoại người nhận')}:</th>
                         <td>{$option['customer']->getU('phone')}</td>
                </tr>
				<tr align="left">
                        <th>Nội Dung</th>
