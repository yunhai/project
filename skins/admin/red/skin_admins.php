...
<div id="page_tabs" class="ui-tabs ui-widget ui-widget-content ui-corner-all-top">
	<ul id="tabs_nav" class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all-inner">
		...
		<if=" $vsSettings->getSystemKey($bw->input['module'].'_user_config_tab', 1, $bw->input['module']) ">
        <li class="ui-state-default ui-corner-top">
      	<a href="{$bw->base_url}settings/moduleObjTab/config/&ajax=1">{$vsLang->getWords("tab_configs_setting",'Cấu hình người dùng')}</a>
     	</li>
     	</if>
</ul>
<div class="clear"></div>
