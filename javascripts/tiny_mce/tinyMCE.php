	...
	function setToolbar($toolbarSet = "") {
		switch ($toolbarSet) {
			case 'full' :
				...
				theme_advanced_buttons2 : "cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,|,vsindent,vsoutdent,vsresetindent,|,blockquote,|,undo,redo,|,link,unlink,anchor,image,cleanup,help,code,|,forecolor,backcolor",
...
EOF;
			...
			case 'simple' :
				$this->toolbarSet = <<<EOF
				theme_advanced_buttons1 : "bold,italic,underline,strikethrough,pasteword,|,justifyleft,justifycenter,justifyright,justifyfull,|,outdent,indent,|,vsindent,vsoutdent,vsresetindent,|,blockquote,|undo,redo,|,link,unlink,anchor,forecolor,backcolor,|,code",
...
EOF;
			...
			case 'narrow' :
				...
				theme_advanced_buttons2 : ",outdent,indent,|,vsindent,vsoutdent,vsresetindent,|,blockquote,|undo,redo,|,link,unlink,anchor,forecolor,backcolor,|,code",
EOF;
				break;
	...
	function createHtml() {
		...
		<script language="javascript" type="text/javascript">
			tinyMCE.init({
				...
				plugins : "vsindent,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,advlist,imagemanager",
