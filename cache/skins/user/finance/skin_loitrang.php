...
class skin_loitrang extends skin_objectpublic {
...
$BWHTML .= <<<EOF
        ...
        <a class="btn btn-success" href="{$bw->base_url}">GO BACK TO THE HOMEPAGE</a>
    </section><!--/#error-->
EOF;
//--endhtml--//
return $BWHTML;
        ...
        <div class="row">
            <aside class="col-sm-4 col-sm-push-8">
                <div class="widget other-post">
                    <h3><span class="glyphicon glyphicon-list"></span>&nbsp;<span class='blue'>{$this->vsLang->getWords("other_post","Other post")}</span></h3>
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="unstyled">
           {$this->__foreach_loop__id_547dd9579d4bd0_92765671($obj,$option)} 
...
$BWHTML .= <<<EOF
  ...
  {$this->__foreach_loop__id_547dd9579d5798_14564582($obj,$option)}
    
  </ol>
  <!-- Wrapper for slides -->
  <div class="carousel-inner">
   {$this->__foreach_loop__id_547dd9579d61c3_40589226($obj,$option)}
...
//===========================================================================
function __foreach_loop__id_547dd9579d4bd0_92765671($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd9579d5798_14564582($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd9579d61c3_40589226($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
                                ...
                                <div class="main_content">
                                    <div class="box_info">
                                        ...
                                        <div class="box_maincontent">
                                            <div class="box_news">
                                            {$this->__foreach_loop__id_547dd9579da242_54667789($option)}
                                          {$this->__foreach_loop__id_547dd9579daff2_02522949($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd9579da242_54667789($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd9579daff2_02522949($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
