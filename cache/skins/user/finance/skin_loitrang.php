            ...
            <aside class="col-sm-4 col-sm-push-8">
                <div class="widget other-post">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="unstyled">
           {$this->__foreach_loop__id_5483138d38a728_05801740($obj,$option)} 
...
$BWHTML .= <<<EOF
  ...
  {$this->__foreach_loop__id_5483138d38dfb9_14222677($obj,$option)}
    
  </ol>
  <!-- Wrapper for slides -->
  <div class="carousel-inner">
   {$this->__foreach_loop__id_5483138d38f4b4_74253038($obj,$option)}
...
//===========================================================================
function __foreach_loop__id_5483138d38a728_05801740($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483138d38dfb9_14222677($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483138d38f4b4_74253038($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
                                ...
                                <div class="main_content">
                                    <div class="box_info">
                                        ...
                                        <div class="box_maincontent">
                                            <div class="box_news">
                                            {$this->__foreach_loop__id_5483138d398366_20977209($option)}
                                          {$this->__foreach_loop__id_5483138d39b343_02477447($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483138d398366_20977209($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483138d39b343_02477447($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
