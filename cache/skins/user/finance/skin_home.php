...
$BWHTML .= <<<EOF
        ...
        <div class="container">
            <div class="row">
            {$this->__foreach_loop__id_548709500d61e5_68950931($option)}
                    ...
                    <div id="scroller" class="carousel slide">
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="row">
                                {$this->__foreach_loop__id_548709500d7318_10953063($option)}                            
...
//===========================================================================
function __foreach_loop__id_548709500d61e5_68950931($option=array())
{
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_548709500d7318_10953063($option=array())
{
global $bw, $vsTemplate, $vsPrint, $vsUser,$menu;
    $BWHTML = '';
    $vsf_count = 1;
