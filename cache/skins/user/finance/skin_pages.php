...
$BWHTML .= <<<EOF
    ...
    <section id="faqs" class="container">
        ...
        {$this->__foreach_loop__id_547dd957a2d0e7_72972215($option)}              
        </ul>
...
//===========================================================================
function __foreach_loop__id_547dd957a2d0e7_72972215($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
            ...
            <aside class="col-sm-4 col-sm-push-8">
                <div class="widget other-post">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="unstyled">
           {$this->__foreach_loop__id_547dd957a32112_25025395($obj,$option)} 
...
$BWHTML .= <<<EOF
  ...
  {$this->__foreach_loop__id_547dd957a32c99_63859184($obj,$option)}
    
  </ol>
  <!-- Wrapper for slides -->
  <div class="carousel-inner">
   {$this->__foreach_loop__id_547dd957a336e5_13567988($obj,$option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a32112_25025395($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a32c99_63859184($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a336e5_13567988($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
                                ...
                                <div class="main_content">
                                    <div class="box_info">
                                        ...
                                        <div class="box_maincontent">
                                            <div class="box_news">
                                            {$this->__foreach_loop__id_547dd957a37569_92406124($option)}
                                          {$this->__foreach_loop__id_547dd957a382e6_40248615($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a37569_92406124($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a382e6_40248615($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
function showSendcontact($option=null) {global $bw,$vsLang,$vsMenu,$vsSettings,$urlcate,$vsExperts,$vsTemplate,$vsPrint;
