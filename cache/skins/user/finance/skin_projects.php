...
$BWHTML .= <<<EOF
 " href="#" data-filter="*">{$this->vsLang->getWords("all_cate","All")}</a></li>
            {$this->__foreach_loop__id_547dd957a7e362_72386027($option)}
            
        </ul><!--/#portfolio-filter-->
        <ul class="portfolio-items col-3">
        
        {$this->__foreach_loop__id_547dd957a7f4a1_15513634($option)}
...
//===========================================================================
function __foreach_loop__id_547dd957a7e362_72386027($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a7f4a1_15513634($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
            ...
            <aside class="col-sm-4 col-sm-push-8">
                <div class="widget other-post">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="unstyled">
           {$this->__foreach_loop__id_547dd957a82c45_16368637($obj,$option)} 
...
$BWHTML .= <<<EOF
  ...
  {$this->__foreach_loop__id_547dd957a83703_61632822($obj,$option)}
    
  </ol>
  <!-- Wrapper for slides -->
  <div class="carousel-inner">
   {$this->__foreach_loop__id_547dd957a842f5_96501493($obj,$option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a82c45_16368637($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a83703_61632822($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a842f5_96501493($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
                                ...
                                <div class="main_content">
                                    <div class="box_info">
                                        ...
                                        <div class="box_maincontent">
                                            <div class="box_news">
                                            {$this->__foreach_loop__id_547dd957a880b8_83514997($option)}
                                          {$this->__foreach_loop__id_547dd957a88e39_14599977($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a880b8_83514997($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547dd957a88e39_14599977($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
