...
$BWHTML .= <<<EOF
    ...
    <section id="services">
        <div class="container">
            ...
            <div class="row">
            {$this->__foreach_loop__id_5483138d457443_53502674($option)}
...
//===========================================================================
function __foreach_loop__id_5483138d457443_53502674($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
                ...
                <div class="widget other-post">
                   <h3><span class="glyphicon glyphicon-list"></span>&nbsp;<span class='blue'>{$this->vsLang->getWords("other_post_{$bw->input[0]}","Other post")}</span></h3>
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="unstyled">
           {$this->__foreach_loop__id_5483138d45b2b3_45199008($obj,$option)} 
...
$BWHTML .= <<<EOF
  ...
  {$this->__foreach_loop__id_5483138d45c3e1_36685966($obj,$option)}
    
  </ol>
  <!-- Wrapper for slides -->
  <div class="carousel-inner">
   {$this->__foreach_loop__id_5483138d45d2d4_95604523($obj,$option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483138d45b2b3_45199008($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483138d45c3e1_36685966($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483138d45d2d4_95604523($obj="",$option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
                                ...
                                <div class="main_content">
                                    <div class="box_info">
                                        ...
                                        <div class="box_maincontent">
                                            <div class="box_news">
                                            {$this->__foreach_loop__id_5483138d466ec3_91597560($option)}
                                          {$this->__foreach_loop__id_5483138d46a8c8_98620049($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483138d466ec3_91597560($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483138d46a8c8_98620049($option=array())
{
global $bw,$vsPrint;
    $BWHTML = '';
    $vsf_count = 1;
