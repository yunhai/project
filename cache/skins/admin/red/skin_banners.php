...
$BWHTML .= <<<EOF
 value="-1">{$this->getLang()->getWords('all')}</option>
{$this->__foreach_loop__id_547ddc104240d2_79874013($option)}
</select>
</label>
...
//===========================================================================
function __foreach_loop__id_547ddc104240d2_79874013($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_547ddc1042e147_95101964($obj,$option)}
</select>
</td>
</tr>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc1042e147_95101964($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
