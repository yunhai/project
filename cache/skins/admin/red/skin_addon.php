...
{$this->__foreach_loop__id_5483ca97c321a4_85475772($arrayObj,$title)}
</select>
</form>
</div>
<script type="text/javascript">
...
//===========================================================================
function __foreach_loop__id_5483ca97c321a4_85475772($arrayObj=array(),$title='')
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<div id='notifylist' style='display:none;'>
        {$this->__foreach_loop__id_5483ca97c35e58_84324406($option)}
        <div id='allnotify'>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483ca97c35e58_84324406($option="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
