...
{$this->__foreach_loop__id_5483ca985c4328_77250910($option)}
</select>
</label>
...
//===========================================================================
function __foreach_loop__id_5483ca985c4328_77250910($option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_5483ca985cb876_93043404($objItems,$option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483ca985cb876_93043404($objItems=array(),$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
