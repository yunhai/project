...
//===========================================================================
function MainPage($list="") {global $bw;
...
<div id="page_tabs">
<ul id="tabs_nav">
        {$this->__foreach_loop__id_5483ca98175d25_41253413($list)}
        <li>
...
//===========================================================================
function __foreach_loop__id_5483ca98175d25_41253413($list="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
function LanguagesMain($show="") {global $bw;
$this->vsLang = $vsLang = VSFactory::getLangs();
$BWHTML = "";
...
//===========================================================================
function addEditLangForm($form="") {global $bw;
$this->vsLang = $vsLang = VSFactory::getLangs();
$BWHTML = "";
...
<tr>
    ...
    <td>{$this->vsLang->getWords('lang_symbol','Symbol')}</td>
       ...
       {$this->__foreach_loop__id_5483ca9817bbd5_32502735($form)}
</select>
        </td>
    </tr>
<tr>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483ca9817bbd5_32502735($form="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
    $vsf_class = '';
    if(is_array($form['flags'])){
...
//===========================================================================
function getLangList($showval="") {global $bw;
$this->vsLang = $vsLang = VSFactory::getLangs();
$show="";
$BWHTML = "";
//--starthtml--//
...
{$this->__foreach_loop__id_5483ca981807b8_88255535($showval)}
</table>
</div>
EOF;
//--endhtml--//
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483ca981807b8_88255535($showval="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
    $vsf_class = '';
    if(is_array($showval['values'])){
...
//===========================================================================
function wordList($showall="") {global $bw,  $vsUser;
$this->vsLang = $vsLang = VSFactory::getLangs();
$BWHTML = "";
//--starthtml--//
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_5483ca98185ec1_25292020($showall)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483ca98185545_47434657($showall="",$module='',$wordlist='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483ca98185ec1_25292020($showall="")
{
global $bw,  $vsUser;
    $BWHTML = '';
    $vsf_count = 1;
    $vsf_class = '';
    if(is_array($showall['WORD_ITEM'])){
    foreach( $showall['WORD_ITEM'] as $module => $wordlist )
    {
        $vsf_class = $vsf_count%2?'odd':'even';
    $BWHTML .= <<<EOF
        
            {$this->__foreach_loop__id_5483ca98185545_47434657($showall,$module,$wordlist)}
...
//===========================================================================
function addLangItemForm($option=array()) {global $bw ,$langtype;
...
<div >
    ...
    <tr>
        <td>{$this->vsLang->getWords('lang_module','Module')}</td>
            ...
            {$this->__foreach_loop__id_5483ca98189ff7_14914999($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483ca98189ff7_14914999($option=array())
{
global $bw ,$langtype;
    $BWHTML = '';
    $vsf_count = 1;
    $vsf_class = '';
    if(is_array($option['lang_list'])){
...
//===========================================================================
function langItem($showall="") {global $bw;
$this->vsLang = $vsLang = VSFactory::getLangs();
$BWHTML = "";
...
$BWHTML .= <<<EOF
    ...
    {$this->__foreach_loop__id_5483ca9818db09_10538786($showall)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_5483ca9818db09_10538786($showall="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
    $vsf_class = '';
    if(is_array( $showall['VAR_LANG_ITEM'])){
...
//===========================================================================
function FileLangMainAjax($show="") {global $bw;
$this->vsLang = $vsLang = VSFactory::getLangs();
...
//===========================================================================
function FileLangMain($show="") {global $bw;
$this->vsLang = $vsLang = VSFactory::getLangs();
$vsSettings = VSFactory::getSettings();
$BWHTML = "";
$storein = $bw->vars['storelangtype']?"File":"Database";
