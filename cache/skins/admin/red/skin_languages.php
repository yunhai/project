...
<div id="page_tabs">
<ul id="tabs_nav">
        {$this->__foreach_loop__id_547ddc106baf15_79786761($list)}
        <li>
...
//===========================================================================
function __foreach_loop__id_547ddc106baf15_79786761($list="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<tr>
    ...
    <td>{$this->vsLang->getWords('lang_symbol','Symbol')}</td>
       ...
       {$this->__foreach_loop__id_547ddc106bf366_96323628($form)}
</select>
        </td>
    </tr>
<tr>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc106bf366_96323628($form="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_547ddc106c24e8_10186525($showval)}
</table>
</div>
EOF;
//--endhtml--//
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc106c24e8_10186525($showval="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_547ddc106c6fb7_92326555($showall)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc106c68a3_17503217($showall="",$module='',$wordlist='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc106c6fb7_92326555($showall="")
{
global $bw,  $vsUser;
    $BWHTML = '';
    $vsf_count = 1;
    ...
    $BWHTML .= <<<EOF
            ...
            {$this->__foreach_loop__id_547ddc106c68a3_17503217($showall,$module,$wordlist)}
...
<div >
    ...
    <tr>
        <td>{$this->vsLang->getWords('lang_module','Module')}</td>
            ...
            {$this->__foreach_loop__id_547ddc106cacd3_87674908($option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc106cacd3_87674908($option=array())
{
global $bw ,$langtype;
    $BWHTML = '';
    $vsf_count = 1;
...
$BWHTML .= <<<EOF
    ...
    {$this->__foreach_loop__id_547ddc106cd926_13486433($showall)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc106cd926_13486433($showall="")
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
