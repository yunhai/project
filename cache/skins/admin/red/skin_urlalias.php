...
//===========================================================================
function objListHtml($option=array()) {global $bw,$vsLang;
$count=2;
$BWHTML = "";
//--starthtml--//
...
$BWHTML .= <<<EOF
        ...
        {$this->__foreach_loop__id_5274ce22bae90($option)}
...
//===========================================================================
function __foreach_loop__id_5274ce22bae90($option=array())
{
global $bw,$vsLang;
    $BWHTML = '';
    $vsf_count = 1;
...
//===========================================================================
// <vsf:showAddEditForm:desc::trigger:>
//===========================================================================
function showAddEditForm($form=array(),$alias="") {global $vsLang;
$BWHTML = "";
//--starthtml--//
...
//===========================================================================
function addEditObjForm($form=array(),$alias="") {global $vsLang,$bw;
