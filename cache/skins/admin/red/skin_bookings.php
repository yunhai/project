...
class skin_bookings extends skin_objectadmin {
...
if($obj->getContent()){
$this->exp=unserialize($obj->getContent());
}
...
<td>
<textareastyle="width: 99%; height: 511px;">
{$this->__foreach_loop__id_547ddc1045dc15_67383403($obj,$option)}
</textarea>
</td>
</tr>
...
//===========================================================================
function __foreach_loop__id_547ddc1045dc15_67383403($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<p><i style="float:left;width:200px">{$key}:</i> {$value}</p>
