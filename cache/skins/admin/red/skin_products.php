...
EOF;
if($this->getSettings()->getKeyGroup($bw->input[0].'_'.$this->modelName.'_promotionPrice','promotionPrice',$bw->input[0].'_'.$this->modelName.'_form')) {
$BWHTML .= <<<EOF

<tr>
<td><label>{$this->getLang()->getWords("promotionPrice","Giá Khuyến mại")}</label></td>
<td>
<input  name="{$this->modelName}[promotionPrice]" type="text" value="{$obj->getPromotionPrice()}" />
</td>
</tr>
...
EOF;
if($this->getSettings()->getKeyGroup($bw->input[0].'_'.$this->modelName.'_warranty','warranty',$bw->input[0].'_'.$this->modelName.'_form')) {
$BWHTML .= <<<EOF

<tr>
<td><label>{$this->getLang()->getWords("warranty","Bảo hành")}</label></td>
<td>
<input  name="{$this->modelName}[warranty]" type="text" value="{$obj->getWarranty()}" />
</td>
</tr>
...
<tr>
<td><label>{$this->getLang()->getWords('avata','Hình ảnh 2')}</label>
<p>
...
<div style="float:left;width:300px">
<label>
<input    type="file" value="" style='width:250px;'  id="avata-file" name="avata"/>
</label>
<br/>
</div>
<div style="float:left;width:200px">
...
{$obj->createImageEditable($obj->getAvata(),100,90,$this->getSettings()->getSystemKey($bw->input[0].'_'.$this->modelName."_image_width",''),$this->getSettings()->getSystemKey($bw->input[0].'_'.$this->modelName."_image_height",''))}
...
{$obj->createImageEditable($obj->getAvata(),100,90)}
...
<tr>
<td><label>Links video</label></td>
<td>
<input size="100" name="{$this->modelName}[video]"  id="videos_obj_code" type="text" value="{$obj->getVideo()}" />
</td>
</tr>
...
{$this->__foreach_loop__id_547ddc108e00d6_90837973($objItems,$option)}
...
//===========================================================================
function __foreach_loop__id_547ddc108e00d6_90837973($objItems=array(),$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
