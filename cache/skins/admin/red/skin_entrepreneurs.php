...
class skin_entrepreneurs extends skin_objectadmin {
...
<input type="hidden" value="{$category->getId()}" name="{$this->modelName}[catId]"/>
...
<tbody>
<tr>
<td style="width: 111px;"><label>{$this->getLang()->getWords('name','Họ tên')}</label></td>
<td>
<input  name="{$this->modelName}[title]" id="{$this->modelName}_title" type="text" value="{$obj->getTitle()}" style='width:99%' />
</td>
</tr>
<tr>
<td style="width: 111px;"><label>{$this->getLang()->getWords('positions','Chức vụ')}</label></td>
<td>
<input  name="{$this->modelName}[positions]" id="{$this->modelName}_positions" type="text" value="{$obj->getPositions()}" style='width:99%' />
</td>
</tr>
<tr>
<td style="width: 111px;"><label>{$this->getLang()->getWords('company','Công ty')}</label></td>
<td>
<input  name="{$this->modelName}[company]" id="{$this->modelName}_company" type="text" value="{$obj->getCompany()}" style='width:99%' />
</td>
</tr>
<tr>
<td style="width: 111px;"><label>{$this->getLang()->getWords('phone','Điện thoại')}</label></td>
<td>
<input  name="{$this->modelName}[phone]" id="{$this->modelName}_phone" type="text" value="{$obj->getPhone()}" style='width:99%' />
</td>
</tr>
<tr>
<td style="width: 111px;"><label>{$this->getLang()->getWords('email','Email')}</label></td>
<td>
<input  name="{$this->modelName}[email]" id="{$this->modelName}_email" type="text" value="{$obj->getEmail()}" style='width:99%' />
</td>
</tr>
<tr>
...
$BWHTML .= <<<EOF
  name="{$this->modelName}[status]" id="{$this->modelName}_status_3" type="radio" value="3"  />
Nổi bật
</label>
