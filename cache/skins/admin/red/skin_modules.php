...
{$this->__foreach_loop__id_547ddc1072f4f1_76709951($obj,$option)}
</select>
</td>
</tr>
...
//===========================================================================
function __foreach_loop__id_547ddc1072f4f1_76709951($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_547ddc1073a1a8_07781436($objItems,$option)}
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc1073a1a8_07781436($objItems=array(),$option=array())
{
    global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
<div class="core">
<h3>Skin_user</h3>
{$this->__foreach_loop__id_547ddc10748685_30116876($option)}
</div>
...
<div class="core">
<h3>Skin_admin</h3>
{$this->__foreach_loop__id_547ddc10748ef7_71982665($option)}
</div>
...
<div class="core">
<h3>Database</h3>
{$this->__foreach_loop__id_547ddc10749658_13065967($option)}
</div>
...
{$this->__foreach_loop__id_547ddc10749de3_57203418($option)}
</div>
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc10748685_30116876($option=array())
{
      global  $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc10748ef7_71982665($option=array())
{
      global  $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc10749658_13065967($option=array())
{
      global  $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc10749de3_57203418($option=array())
{
      global  $bw;
    $BWHTML = '';
    $vsf_count = 1;
