...
//===========================================================================
function addOtionList($obj="") {global $vsLang, $bw,$vsSettings,$tableName;
...
//===========================================================================
function addEditObjForm($objItem="",$option=array()) {global $vsLang, $bw,$vsSettings,$tableName;
...
//===========================================================================
// <vsf:displayGalleryAlbumList:desc::trigger:>
//===========================================================================
function displayGalleryAlbumList($albumList="",$option="") {global $bw,$vsLang,$vsSettings;
$count = 0;
...
{$this->__foreach_loop__id_50ab944d4d74d($albumList,$option)}
...
//===========================================================================
function __foreach_loop__id_50ab944d4d74d($albumList="",$option="")
{
...
//===========================================================================
function addEditFileForm($form=array(),$file="",$album="") {global $bw, $vsLang, $vsSettings;
$BWHTML = "";
if(!$album->getCode())
...
<input type="hidden" name="oldFileTitle" value="{$file->getTitle()}" />
...
{$vsLang->getWords('file_upload_form_name',"Filename")}:
...
<tr>
<td class="normalcell" width="100">{$vsLang->getWords('file_url',"FileIntro")}:</td>
...
EOF;
if($vsSettings->getSystemKey($album->getCode().'_file_index', 0, $album->getCode())) {
$BWHTML .= <<<EOF
...
EOF;
if($vsSettings->getSystemKey($album->getCode().'_multiupload',0,$album->getCode())) {
$BWHTML .= <<<EOF

<tr >
<td class="normalcell">
<span class="form_multi">{$vsLang->getWords('multiupload', "Multi Upload")}:</span>
</td>
...
<tr>
<td class="normalcell" width="100">{$vsLang->getWords('file_status',"FileStatus")}:</td>
...
//===========================================================================
// <vsf:displayGalleryFileList:desc::trigger:>
//===========================================================================
function displayGalleryFileList($file="",$albumId="") {global $vsLang, $bw;
...
{$this->__foreach_loop__id_50ab944d4e305($file,$albumId)}
...
// Foreach loop function 
//===========================================================================
function __foreach_loop__id_50ab944d4e305($file="",$albumId="")
{
global $vsLang, $bw;
    $BWHTML = '';
    $vsf_count = 1;
