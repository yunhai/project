...
<td>
{$this->__foreach_loop__id_547ddc1032f585_65611301($obj,$option)}
...
//===========================================================================
function __foreach_loop__id_547ddc1032e986_48669749($obj="",$option=array(),$module='',$list='')
{
;
    $BWHTML = '';
    $vsf_count = 1;
...
// Foreach loop function ifstatement
//===========================================================================
function __foreach_loop__id_547ddc1032f585_65611301($obj="",$option=array())
{
global $bw;
    $BWHTML = '';
    $vsf_count = 1;
...
{$this->__foreach_loop__id_547ddc1032e986_48669749($obj,$option,$module,$list)}
