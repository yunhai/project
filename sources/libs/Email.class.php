 ...
 *
 */
class Emailer implements interfaceEmail
{
	/**
	 * From email address 
	 *
	...
	public function __construct()
	{
		...
		$opts = array( 
		        ...
		        'charset'  	=> 'utf-8',
		        'method' 	=> 'smtp',
		        'smtp_host' =>"mail.lysontravel.org",//  VSFactory::getSettings()->getSystemKey("smtp_host","websiteviet.com","configs"),
		        'smtp_port' => 25,
				'smtp_user' =>"ly-son-travel@lysontravel.org",// VSFactory::getSettings()->getSystemKey("smtp_user","customer@vstatic.net","configs"),
				'smtp_pass' => "baotrung123",//VSFactory::getSettings()->getSystemKey("smtp_password","@customer#*#%@","configs"),
		        'smtp_helo' => 'EHLO',
		        'wrap_brackets' => false);
	...
	{	
        ...
        foreach( $enc_headers as $header => $value) 
        {
            ...
            if( !count($headers) AND $header != 'Subject' )
            {
